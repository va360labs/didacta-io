...
/// Bloque 7 — panel de métricas del negocio: pocos KPIs que se miran todos los
/// lunes. Todo sale de la BD local (webhooks ya materializados); nada de APIs
/// externas en caliente.
...
export default function AdminMetricasPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-5">
      <div>
        <h1 className="text-xl font-bold text-text">Métricas del negocio</h1>
        <p className="mt-1 text-sm text-text-muted">
          Los KPIs del lunes: comunidad, ventas y salud de la membresía. Ventana de 30 días salvo
