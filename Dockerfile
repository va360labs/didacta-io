...
# Sobreescribible con: docker build --build-arg DIDACTA_VERSION=0.0.1-alpha.46
ARG DIDACTA_VERSION=0.0.1-alpha.46
...
ENV NODE_ENV=production \
    ...
    API_PORT=4000 \
    WEB_PORT=3000 \
    DIDACTA_CORE_VERSION=${DIDACTA_VERSION:-0.0.1-alpha.46}
