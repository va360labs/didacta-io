...
# Sobreescribible con: docker build --build-arg DIDACTA_VERSION=0.0.1-alpha.49
ARG DIDACTA_VERSION=0.0.1-alpha.49
...
ENV NODE_ENV=production \
    ...
    API_PORT=4000 \
    WEB_PORT=3000 \
    DIDACTA_CORE_VERSION=${DIDACTA_VERSION:-0.0.1-alpha.49}
